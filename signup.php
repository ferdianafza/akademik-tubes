...
if ( isset($_POST["register"])) {
  ...
  if (registrasi($_POST) > 0 ) {
    echo "<script>
            alert('Mahasiswa Berhasil terdatar!!!, silahkan Login')
          </script>" ;
  } else {
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form method="POST">
          ...
          <div class="form-outline mb-4">
            <input type="text" name="nim" id="form3Example3" class="form-control form-control-lg"
              placeholder="NIM" />
          </div>
          <div class="form-outline mb-4">
          ...
          <div class="form-outline mb-4">
            <input type="text" name="jurusan" id="form3Example3" class="form-control form-control-lg"
              placeholder="Jurusan" />
          </div>
          <div class="form-outline mb-4">
